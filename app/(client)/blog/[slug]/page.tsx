...
const SingleBlogPage = async ({
  ...
  // normalize result: getSingleBlog may return an array (e.g. [] or [blog]) or a single blog object
  const _res = await getSingleBlog(slug);
  const blog: SINGLE_BLOG_QUERYResult | undefined = Array.isArray(_res) ? _res[0] : _res;
